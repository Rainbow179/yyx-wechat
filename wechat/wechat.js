...
(async () => {
  ...
  //上传图片获取media_id
  let result1 = await w.uploadMaterial('image', './logo.jpg');
  console.log(result1);
  /*
   { media_id: '8FpT055Wb8qXDmCxltG6e_Lt_DtCqR0qLsWUC_djMuI',
   url: 'http://mmbiz.qpic.cn/mmbiz_jpg/TbEmzIPL5dicP6P7eqzr7OH1NhWB5woJ6ndbpGDmVYNcw73Sa5lM5888HUxCvIYVCDl74ukh7G6gjr0esQCBUog/0?wx_fmt=jpeg' }
   */
    //上传图片获取地址
  let result2 = await w.uploadMaterial('pic', './wx.png');
  console.log(result2);
  /*
   { url: 'http://mmbiz.qpic.cn/mmbiz_png/TbEmzIPL5dicP6P7eqzr7OH1NhWB5woJ6TCIF3BiaTX0F1CnuyXIHnZMiaZQuIuqVvcScVk7uCtAj3heT2fvuTOjg/0' }
   */
  //上传图文消息
  ...
  console.log(result3);
  /*
   { media_id: '8FpT055Wb8qXDmCxltG6e0MkeQAXyfQs8J-fgC2a8SU' }
   */
